...
import static com.oyealex.anfs.rpc.utils.RpcConstants.PROCEDURE_MOUNT_UMNT;
 ...
 * @since 2021/3/14
 */
public class UmntRequest extends RpcCall {
    private final String export;

    protected UmntRequest(Auth credentials, Auth verifier, String export) {
        super(PROGRAM_MOUNT, PROGRAM_VERS_MOUNT_V3, PROCEDURE_MOUNT_UMNT, credentials, verifier);
        this.export = export;
    }
